  ...
  return (
    <div>
      <div className='flex justify-center'>
        <div className=' flex-col items-center justify-center w-7/12   '>
          {/* 头部视频介绍 */}
          <div className='flex justify-center h-80 '>
            <video
              controls
              className=' w-2/3 h-80 object-cover rounded-lg'
              src={videoUrl}></video>

            <div className='ml-6'>
              <p className='text-gray-700 text-lg font-medium tracking-wider h-10 flex items-center font-sans'>
                课程介绍
              </p>

              <p className='tracking-wider sm:text-sm xl:text-base text-gray-400 h-60 py-2 font-medium font-sans'>
                {courseIntroduction}
              </p>
              ...
              <li className='flex text-xl items-center space-x-1'>
                ...
                <p className='text-xs tracking-wider text-gray-300 font-sans pt-5 '>
                  视频分类:教育
                </p>
              </li>
            </ul> */}
          ...
          <div className=' flex-col justify-start pt-5 items-center my-2'>
            <p className='text-gray-700 text-base font-semibold tracking-wider h-10 flex items-center font-sans'>
              软件设计体系结构
            </p>
            <div className='pt-2  '>
              <Tree
